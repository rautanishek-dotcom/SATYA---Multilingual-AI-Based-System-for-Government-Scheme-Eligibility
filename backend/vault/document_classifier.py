...
class DocumentClassifier:
    ...
    def classify_by_text(full_text: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "document_label": best_type.replace("_", " ").title() if best_type != "unknown" else "Unknown Document",
            "probability": prob,
    ...
    def classify(file_path: str, original_filename: str = None, mime_type: str = None, hint_text: str = "") -> Dict[str, Any]:
        """Legacy wrapper that forces OCR-based classification (Phase 3)."""
        ...
        # Returning placeholder until ocr_engine processes it
        return {
